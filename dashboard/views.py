...
def homework_detail(request, homework_id):
    ...
    return render(request, 'dashboard/homework_details.html', {'homework': homework})
...
def todo_details(request, pk):
    ...
    return render(request, 'dashboard/todo_details.html', {'todo': todo})
